    ...
    <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg">
      <CardContent className="p-6">
        <div className="flex flex-col space-y-4">
          ...
          <Tabs defaultValue="keyword" value={searchType}  className="h-16 lg:h-10 w-full">
            <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4">
              <TabsTrigger value="keyword">Keywords/Title</TabsTrigger>
      ...
      {debouncedSearchQuery && (
        <AISuggestedFilters query={debouncedSearchQuery} onApplyFilter={handleApplySuggestedFilter} />
            ...
            <div className="flex">
              ...
              <Button variant="outline" size="icon" className="h-12 w-12" onClick={handleFilterToggle}>
          ...
          <p className="text-xs text-muted-foreground">
            <span className="font-medium">AI-Enhanced:</span> Our search uses machine learning to improve results based
